...
<html lang="en">
    ...
    <label for="id" class="form-label">N° de Socio</label>
      <input type="text" readonly="readonly" class="form-control dato"style="background-color: transparent;" id="id" name="id" require="true" value="<?=$id ?>">
    <label for="nombre" class="form-label">Nombre Completo</label>
      <input type="Text" class="form-control dato" id="nombre" name="nombre" placeholder="Nombre" require="true" value="<?=$nombre?>">
    <label for="domicilio" class="form-label">Domicilio</label>
      <input type="text" class="form-control dato" id="domicilio" name="domicilio"  require="true" value="<?=$domicilio?>">
    <label for="localidad" class="form-label">Localidad</label>
      <input type="text" class="form-control dato" id="localidad" name="localidad"  require="true" value="<?=$localidad?>">
    <label for="provincia" class="form-label">Provincia</label>
      <input type="text" class="form-control dato" id="provincia" name="provincia"  require="true" value="<?=$provincia?>">
    <label for="telefono" class="col-sm-1 col-form-label">Telefono</label>
      <input type="text" class="form-control dato" id="telefono" name="telefono"  require="true" value="<?=$telefono?>">
    <label for="celular" class="form-label">Celular</label>
      <input type="text" class="form-control dato" id="celular" name="celular"  require="true" value="<?=$celular?>">
    <label for="mail" class="form-label">Mail</label>
      <input type="text" class="form-control dato" id="mail" name="mail"  require="true" value="<?=$mail?>">
    <label for="DNI" class="form-label">DNI</label>
      <input type="text" class="form-control dato" id="DNI" name="DNI"  require="true" value="<?=$dni?>">
    <label for="nacionalidad" class="form-label">Nacionalidad</label>
      <input type="text" class="form-control dato" id="nacionalidad" name="nacionalidad"  require="true" value="<?=$nacionalidad?>">
    <label for="nacimiento" class="form-label">Fecha de nacimiento</label>
      <input type="date" class="form-control dato" id="nacimiento" name="nacimiento"  require="true" value="<?=$nacimiento?>">
    <label for="ecivil" class="form-label">Estado civil</label>
      <input type="text" class="form-control dato" id="ecivil" name="ecivil"  require="true" value="<?=$ecivil?>">
    <label for="profesion" class="col-sm-1 col-form-label">Profesion</label>
      <input type="text" class="form-control dato" id="profesion" name="profesion"  require="true" value="<?=$profesion?>">
...
<h4 class="h5">Completar solo si el socio es menor de edad:</h4>
    ...
    <label for="apellido-nombre" class="form-label">Apellido y Nombre</label>
      <input type="text" class="form-control dato" id="apellido-t" name="apellido-t" placeholder="Apellido" value="<?=$apellido_t?>">
    <label for="telefono-t" class="col-sm-1 col-form-label">Telefono</label>
      <input type="text" class="form-control dato" id="telefono-t" name="telefono-t" value="<?=$telefono_t?>">
    <label for="celular-t" class="form-label">Celular</label>
      <input type="text" class="form-control dato" id="celular-t" name="celular-t" value="<?=$celular_t?>">
    <label for="DNI-t" class="form-label">DNI</label>
      <input type="text" class="form-control dato" id="DNI-t" name="DNI-t" value="<?=$DNI_t?>">
    <label for="nacionalidad-t" class="form-label">Nacionalidad</label>
      <input type="text" class="form-control dato" id="nacionalidad-t" name="nacionalidad-t" value="<?=$nacionalidad_t?>">
    <label for="nacimiento-t" class="form-label">Fecha de nacimiento</label>
      <input type="date" class="form-control dato" id="nacimiento-t" name="nacimiento-t" value="<?=$nacimiento_t?>">
    <label for="ecivil-t" class="form-label">Estado civil</label>
      <input type="text" class="form-control dato" id="ecivil-t" name="ecivil-t" value="<?=$ecivil_t?>">
    <label for="profesion-t" class="col-sm-1 col-form-label">Profesion</label>
      <input type="text" class="form-control dato" id="profesion-t" name="profesion-t" value="<?=$profesion_t?>">
  ...
  <a class="btn btn-primary rounded" href="eliminar_socio.php?data=<?php echo $id; ?>">eliminar socio</a>  
